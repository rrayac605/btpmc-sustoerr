...
@Component
@StepScope
public class SusceptiblesOtrasProcessor implements ItemProcessor<MovimientoDTO, MovimientoDTO>{
	private static final Logger logger = LoggerFactory.getLogger(SusceptiblesOtrasProcessor.class);
	...
	public MovimientoDTO process(MovimientoDTO movimientoDTO) {
		...
		asegurado.setCveEstadoRegistro(SusToErrConstantes.CVE_ERRONEO_OTRAS);
		asegurado.setDesEstadoRegistro(SusToErrConstantes.DES_ERRONEO_OTRAS);
